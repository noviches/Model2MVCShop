	...
	<head>
		...
		<script type="text/javascript">
			...
			function totalPrice(price, quantity) {
				...
				// $("input[name='totalPrice']").parent().append(total+" 원");
		...
		<div style="width:98%; margin-left:10px;">
			<form name="addPurchase">
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">${product.reQuantity}&nbsp;개</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				</tr>
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
						<input type="number" name="quantity" class="ct_input_g" style="width:30px;" min="1">&nbsp;개
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				...
				<tr>
					<td width="104" class="ct_write">총구입금액</td>
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
					...
					<td align="center">
						...
						<tr>
							...
							<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
								...
								<span style="cursor:pointer">구매</span>
							</td>
