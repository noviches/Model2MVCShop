...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//==> 추가된 부분 : "이메일" 유효성 Check Event 처리 및 연결
			$( function(){
		...
		<div style="width:98%; margin-left:10px;">
			...
			<form name="detailForm" >
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
						<select name="phone1" class="ct_input_g" style="width:50px; height:25p;x" onChange="document.detailForm.phone2.focus();">
