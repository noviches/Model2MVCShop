...
public class ProductController {
	...
	@RequestParam(value="file", required=false) MultipartFile[] files, HttpServletRequest request, Model model) throws Exception {
		
		System.out.println("/product/addProduct : POST");
		
		/////////////////////////////// 파일 업로드 ///////////////////////////////
		String savePath = "C:\\Users\\USER\\git\\10\\10.Model2MVCShop(Ajax)\\WebContent\\images\\uploadFiles";
	...
	@RequestParam(value="file", required=false) MultipartFile[] files, Model model, HttpSession session) throws Exception {
