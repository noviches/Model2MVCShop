			...
			<form name="detailForm" action="/listProduct.do" method="post" onsubmit="return false">
				...
				<tr>
					<td align="right">
						...
						<input type="text" name="searchKeyword" value="<%= searchKeyword %>" onkeypress="if(event.keyCode==13) {javascript:fncGetUserList('1');}" class="ct_input_g" style="width:200px; height:19px;" />
					</td>
