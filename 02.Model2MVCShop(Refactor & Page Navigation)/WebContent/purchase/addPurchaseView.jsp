		...
		<div style="width:98%; margin-left:10px;">
			<form name="addPurchase" method="post" action="/addPurchase.do">
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
						<input type="text" name="receiverName" class="ct_input_g" style="width:100px; height:19px;" maxLength="20" value="<%= user.getUserName() %>" />
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
						<input type="text" name="receiverPhone" class="ct_input_g" style="width:100px; height:19px;" maxLength="20" value="<%= user.getPhone() %>" />
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
						<input type="text" name="receiverAddr" class="ct_input_g" style="width:100px; height:19px;" maxLength="20" value="<%= user.getAddr() %>" />
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
