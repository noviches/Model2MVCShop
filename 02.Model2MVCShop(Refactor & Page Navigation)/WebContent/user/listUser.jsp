...
<html>
	...
	<body bgcolor="#ffffff" text="#000000">
		<div style="width:98%; margin-left:10px;">
			<form name="detailForm" action="/listUser.do" method="post" onsubmit="return false">
				...
				<tr>
					<td align="right">
						...
						<input type="text" name="searchKeyword" value="<%= searchKeyword %>" onkeypress="if(event.keyCode==13) {javascript:fncGetUserList('1');}" class="ct_input_g" style="width:200px; height:20px;">
					</td>
