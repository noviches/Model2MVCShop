...
<html>
	...
	<body bgcolor="#ffffff" text="#000000" >
		<form name="loginForm" method="post" action="/login.do" target="_parent">
			<div align="center">
				<table with="100%" height="100%" border="0" cellpading="0" cellspacing="0">
				<tr>
									...
									<td width="305">
						          	...
						          	<td width="345" align="left" valign="top" background="/images/login02.gif">
										...
										<tr> 
											...
											<td height="30">
												<input type="text" name="userId" class="ct_input_g" style="width:180px; height:19px;" maxLength="50" autofocus />          
											</td>
