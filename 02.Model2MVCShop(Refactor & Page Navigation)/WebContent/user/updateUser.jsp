...
<html>
	...
	<body bgcolor="#ffffff" text="#000000">
		<div style="width:98%; margin-left:10px;">
			<form name="detailForm"vmethod="post" >
				...
				<tr>
					...
					<td class="ct_write01">
						...
						<input type="text" name="phone2" value="<%= phone2.equals("")? "" : phone2 %>" class="ct_input_g" style="width:100px; height:19px;" maxLength="9">
						- 
						<input type="text" name="phone3" value="<%= phone3.equals("")? "" : phone3 %>" class="ct_input_g" style="width:100px; height:19px;" maxLength="9">
