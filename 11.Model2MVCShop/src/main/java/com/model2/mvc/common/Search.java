...
public class Search {
	...
	//==> UserMapper.xml 의 <select id="getUserList" parameterType="search" resultMap="userSelectMap"> 참조
	...
	public String toString() {
		return "Search [currentPage=" + currentPage + ", searchCondition=" + searchCondition
				+ ", searchKeyword=" + searchKeyword + ", searchCode=" + searchCode
