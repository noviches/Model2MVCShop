		...
		<div style="width:98%; margin-left:10px;">
			<form name="detailForm" method="post">
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
						<input type="text" name="userName" value="<%= vo.getUserName() %>" class="ct_input_g" style="width:100px; height:19px;" maxLength="50" >
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
						<input type="text" name="addr" value="<%= vo.getAddr() %>" class="ct_input_g" style="width:370px; height:19px;" maxLength="100">
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				...
				<tr>
					...
					<td class="ct_write01">
						...
						<input type="text" name="phone2"
							<% if(vo.getPhone() != null) { %> value="<%= vo.getPhone().split("-")[1] %>" <% } %>
						class="ct_input_g" style="width:100px; height:19px;" maxLength="9">
						- 
						<input type="text" name="phone3" 
							<% if(vo.getPhone() != null) { %> value="<%= vo.getPhone().split("-")[2] %>" <% } %>
						class="ct_input_g" style="width:100px; height:19px;" maxLength="9">
				...
				<tr>
					...
					<td class="ct_write01">
						...
						<tr>
							<td height="26">
								<input 	type="text" name="email" value="<%= vo.getEmail() %>" class="ct_input_g" style="width:100px; height:19px;" onChange="check_email(this.form);">
							</td>
						</tr>
						</table>
					</td>
