			...
			<form name="detailForm" action="/listUser.do" method="post">
				...
				<tr>
					<td align="right">
						...
						<input type="text" name="searchKeyword" value="${ ! empty search.searchKeyword ? search.searchKeyword : '' }" class="ct_input_g" style="width:200px; height:23px;"> 
					</td>
				...
				<tr>
					...
					<td class="ct_list_b" width="230">회원ID</td>
					<td class="ct_line02"></td>
					<td class="ct_list_b" width="230">회원명</td>
					<td class="ct_line02"></td>
				...
				<c:forEach var="user" items="${list}">
					...
					<tr class="ct_list_pop">
						...
						<td></td>
						<td align="left" style="padding-left:30px;">${user.userName}</td>
						<td></td>
						<td align="left" style="padding-left:30px;">${user.email}</td>		
					</tr>
					<tr>
