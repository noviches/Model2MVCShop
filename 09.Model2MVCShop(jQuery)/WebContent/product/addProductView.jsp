			...
			<form name="detailForm">
				...
				<tr>
					...
					<td class="ct_write01">
						...
						<tr>
							<td width="105">
								<input type="text" name="prodName" class="ct_input_g" style="width:150px; height:19px;" maxLength="20">
							</td>
						</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
						<input type="text" name="prodDetail" class="ct_input_g" style="width:150px; height:19px;" maxLength="10" minLength="6" />
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
				...
				<tr>
					...
					<td bgcolor="D6D6D6" width="1"></td>
					<td class="ct_write01">
						<input type="number" name="reQuantity" class="ct_input_g" style="width:30px;" min="1">&nbsp;개
					</td>
				</tr>
				<tr>
					<td height="1" colspan="3" bgcolor="D6D6D6"></td>
					...
					<td align="right">
						...
						<tr>
							...
							<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
								...
								<span style="cursor:pointer;">등록</span>
							</td>
