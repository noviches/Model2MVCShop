...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//* ============= jQuery 추가된 부분 : 회원가입 화면이동 =============
			$( function(){
				//==> 추가된 부분 : "addUser" Event 연결
								...
								<tr>
									...
									<td width="345" align="left" valign="top" background="/images/login02.gif">
										...
										<tr> 
											...
											<td height="30">
												<input type="text" name="userId" id="userId" class="ct_input_g" style="width:180px; height:19px;" maxLength='50' />          
											</td>
