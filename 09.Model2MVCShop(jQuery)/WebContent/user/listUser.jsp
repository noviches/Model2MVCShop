...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//==> 추가된 부분 : "검색", userId link Event 연결 및 처리
			$( function(){	 
				//==> 검색 Event 연결처리부분
		...
		<div style="width:98%; margin-left:10px;">
			...
			<form name="detailForm">
				...
				<tr>
					...
					<td class="ct_line02"></td>
					<td class="ct_list_b" width=200">회원명</td>
					<td class="ct_line02"></td>
				...
				<c:forEach var="user" items="${list}">
					...
					<tr class="ct_list_pop">
						...
						<td align="left">
							...
							///////////////////////////////////////////////////////////////// -->
							<span style="cursor:pointer; padding-left:40px;">${user.userId}</span>
						</td>
						<td></td>
						<td align="left"><sapn style="padding-left:40px;">${user.userName}</sapn></td>
						<td></td>
