...
public class ProductController {
	...
	public ModelAndView addProduct(@ModelAttribute("product") Product product, @RequestParam("fileTitle") MultipartFile fileTitle,
	@RequestParam("file") MultipartFile[] files, HttpServletRequest request, Model model) throws Exception {
		
		System.out.println("/product/addProduct : POST");
		
		/////////////////////////////// 파일 업로드 ///////////////////////////////
		String savePath = "E:\\eclipse-workspace\\09.Model2MVCShop(jQuery)\\WebContent\\images\\uploadFiles";
		...
		if(product.getFileName() != null && product.getFileName() != "") {
			...
			model.addAttribute("files", fileArray);
		}
	...
	public ModelAndView updateProduct(@ModelAttribute("product") Product product, @RequestParam("fileTitle") MultipartFile fileTitle,
	@RequestParam("file") MultipartFile[] files, Model model, HttpSession session) throws Exception {
